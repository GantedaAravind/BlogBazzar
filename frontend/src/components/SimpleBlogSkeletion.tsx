    ...
    <div className="border-2 placeholder-wave rounded-lg border-zinc-500 w-full p-2 flex my-2 justify-between gap-4 relative">
      <div className="w-[90%] sm:w-[85%] md:w-[80%] lg:w-[75%]">
        ...
        <div className="flex items-center justify-between w-full ">
          <div className="flex  gap-4 w-full items-center">
            ...
            <div className="flex flex-col w-[15%]">
              <h2 className="text-base rounded-sm sm:text-md md:text-lg lg:text-xl w-full placeholder "></h2>
              <p className="text-sm md:text-base text-zinc-400 w-full mt-1 rounded-sm placeholder"></p>
            </div>
          </div>
        ...
        <div className="mt-2 rounded-sm w-full ">
            ...
            <p className=" placeholder block m-1 w-[80%]"></p>
            <p className=" placeholder hidden md:block m-1 w-[50%]"></p>

        </div>
      </div>
      <div>
        <div className="h-28 placeholder sm:h-32 md:h-36 lg:h-40 aspect-[5/3] rounded-md" />
      </div>
    </div>
  );
};
